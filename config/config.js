...
var categories = [
    ...
    [5, 'Salud', 'Health'],
    [6, 'Minería', 'Mining'],
    [7, 'Cultivos y Ganadería', 'Crops and Livestock'],
    [8, 'Comercio y Manufactura', 'Commerce and Manufacturing'],
    [9, 'Turismo y comercio', 'Tourism'],
    [10, 'Sector Forestal', 'Forestry'],
    [11, 'Transporte', 'Transportation'],
    [12, 'Agua y Alcantarillado', 'Water and Sewerage'],
    [13, 'Energía', 'Power'],
...
var layers = [
    [1, 4, 'geonode:SCHOOLS_DALA_GUY_3857', 'Escuelas', 'Schools', 'Equipo de evaluación con datos del Ministerio de Educación, GUYNODE y OpenStreetMap', 'Assessment team with Ministry of Education, GUYNODE and OpenStreetMap data', 'Esta capa muestra las instalaciones escolares en Guyana.', 'This layer shows the school facilities in Guyana'],
    [2, 14, 'geonode:GUY_RIVERS', 'Ríos', 'Rivers', 'Comisión de Tierras y Encuestas de Guyana', 'Guyana Lands and Surveys Commission', 'Esta capa muestra los principales ríos de Guyana.', 'This layer shows the main rivers of Guyana'],
    ...
    [4, 14, 'geonode:GUY_NATURAL_ZONES', 'Zonas naturales', 'Natural zones', 'Comisión de Tierras y Encuestas de Guyana', 'Guyana Lands and Surveys Commission', 'Esta capa muestra las regiones naturales de Guyana.', 'This layer shows the natural regions of Guyana'],
    [5, 2, 'geonode:GUY_MAIN_TOWNS_POLY', 'Principales ciudades (polígonos)', 'Main towns (polygons)', 'Equipo de evaluación con datos de OpenStreetMap', 'Assessment team with OpenStreetMap data', 'Esta capa muestra las principales ciudades de Guyana.', 'This layer shows the main towns of Guyana'],
    [6, 2, 'geonode:GUY_MAIN_TOWNS_POINTS', 'Principales ciudades (puntos)', 'Main towns (points)', 'Equipo de evaluación con datos de OpenStreetMap', 'Assessment team with OpenStreetMap data', 'Esta capa muestra las principales ciudades de Guyana clasificadas como ciudades, pueblos y aldeas.', 'This layer shows the main towns of Guyana classified as City, Towns and Villages'],
    [7, 11, 'geonode:GUY_MAIN_ROADS', 'Caminos principales', 'Main roads', 'Equipo de evaluación con datos de OpenStreetMap', 'Assessment team with OpenStreetMap data', 'Esta capa muestra las principales carreteras de Guyana.', 'This layer shows the main roads of Guyana'],
    [8, 14, 'geonode:GUY_MAIN_RIVERS', 'Ríos principales', 'Main rivers', 'Comisión de Tierras y Encuestas de Guyana', 'Guyana Lands and Surveys Commission', 'Esta capa muestra los principales ríos de Guyana.', 'This layer shows the main rivers of Guyana'],
    [9, 14, 'geonode:GUY_LAND_USE_COASTAL_PLAIN_2010', 'Uso de suelo costero', 'Coastal land use', 'Comisión Forestal de Guyana, 2010', 'Guyana Forestry Commission, 2010', 'Esta capa muestra los límites de las unidades de uso / tenencia de la tierra a lo largo de la llanura costera en la parte noreste de Guyana. El conjunto de datos se actualizó utilizando imágenes de satélite de resolución media (LANDSAT TM de 2010/2011), durante el proyecto de desarrollo del plan de uso de la tierra, sin embargo, no se realizó ningún trabajo de campo en este momento.', 'This layer shows boundaries of Land Use / tenure units  along the Coastal Plain the the north-eastern part of Guyana. The dataset was updated using a medium resolution satellite imagery (LANDSAT TM from 2010/2011), during the Development of the Land Use plan project however no field work was conducted at this time.'],
    [10, 14, 'geonode:GUY_LAND_COVER_USE_2010', 'Uso de cobertura de suelo', 'Land cover use', 'Comisión Forestal de Guyana, 2010', 'Guyana Forestry Commission, 2010', 'Esta capa resume la cobertura y el uso del suelo en Guyana según los mapas de vegetación elaborados por GFC (2010) y Huber et al (1995), que se actualizaron utilizando un mosaico de imágenes satelitales LANDSAT TM de 2010/2011.', 'This layer summarizes the Land Cover / Land Use in Guyana  based on the vegetation maps made by GFC (2010) and Huber et al (1995), which were updated using a mosaic of LANDSAT TM satellite imagery from 2010/2011'],
    ...
    [13, 11, 'geonode:GUY_AIRPORTS', 'Aeropuertos', 'Airports', 'Comisión de Tierras y Encuestas de Guyana', 'Guyana Lands and Surveys Commission', 'Esta capa muestra los aeropuertos y pistas de aterrizaje en Guyana.', 'This layer shows the airports and airstrips in Guyana'],
    [14, 5, 'geonode:GUY_HEALTH_FACILITIES', 'Centros de salud', 'Health facilities', 'Comisión de Tierras y Encuestas de Guyana','Guyana Lands and Surveys Commission', 'Esta capa muestra los diferentes tipos de establecimientos de salud en Guyana.','This layer shows the different types of health facilities in Guyana'],
